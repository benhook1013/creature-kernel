...
AUTHORED_SUMMARY_TEXT = (
    "This gallery shows the cumulative Stage 1 regional-surface candidate across "
    "five body profiles; judge overall simplified humanoid coherence plus the "
    "retained visible areas—reduced upper-pelvis bell flare, hip-cup/thigh seating, "
    "neck-to-collar integration, and forearm-to-hand transition—while watching for "
    "lumps, pinches, or disconnected forms."
)
EXPECTED_SAMPLES = 56

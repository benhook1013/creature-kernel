...
| [DR-0002](DR-0002-declarative-body-document-source-of-truth.md) | Authoritative semantic source set and resolved body graph | Specification and architecture | Proposed | 9 | Pending | Ben |
...
| [DR-0008](DR-0008-first-digitigrade-morphology-and-embodiment-envelope.md) | First digitigrade morphology and Stage 1 embodiment envelope | Product, Specification and architecture | Proposed | 9 | Pending | Ben |
...
| [DR-0011](DR-0011-minimal-semantic-vocabulary-measurements-and-frames.md) | Minimal semantic vocabulary, measurements, and frames | Specification and architecture | Proposed | 5 | Pending | Ben |
| [DR-0012](DR-0012-initial-body-document-encoding-resolution-and-compatibility.md) | Initial body-document encoding, resolution, and compatibility | Specification and architecture | Proposed | 4 | Pending | Ben |
| [DR-0013](DR-0013-first-production-implementation-platform-and-geometry-boundary.md) | First production implementation platform and geometry boundary | Architecture | Proposed | 2 | Pending | Ben |
...
Pending. The exact-revision Batch 5 Double review at commit
...
not a clean review and not acceptance. A fresh current-revision Double review
of all five records is pending. Their selected status/primary-diagnostic,
...
revisions above. A fresh current-revision Double review is pending; prior
...
resolutions, not owner acceptance; current-revision review remains pending.

...
| --- | --- | --- | --- | --- | --- | --- |
| [DR-0001](DR-0001-documentation-authority-and-review-process.md) | Documentation authority and decision-record process | Governance | Proposed | 5 | Complete | Ben |
...
| [DR-0009](DR-0009-hybrid-surface-generation-experiment-hypothesis.md) | Hybrid surface-generation experiment hypothesis | Architecture | Proposed | 2 | Complete | Ben |
| [DR-0010](DR-0010-stage-1-surface-extraction-and-semantic-field-propagation.md) | Stage 1 surface extraction and semantic-field propagation | Specification and architecture | Proposed | 2 | Complete | Ben |

All listed decisions remain `Proposed`; owner approval remains `Pending` in
their records. DR-0001 Revision 5 completed its Single review. DR-0009 and
DR-0010 Revision 2 completed their Double reviews with distinct named lenses.
Reviews of prior revisions remain historical and stale.

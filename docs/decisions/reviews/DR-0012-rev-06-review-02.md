...
Revision 6 separates resolver snapshot completion from external serialization
and clarifies operation-specific payload requirements. No DR-0012-specific
blocker was identified by this pass.

## Blocking Objections

No DR-0012-specific blocking objection. R2-F1 through R2-F4 are cross-cutting
findings owned by DR-0006 and/or DR-0013.

## Non-blocking Risks

The exact resolver and build-operation formats, filesystem profile, and
implementation evidence remain deferred in the owning records.
